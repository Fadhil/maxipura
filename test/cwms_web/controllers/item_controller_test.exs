defmodule CwmsWeb.ItemControllerTest do
  use CwmsWeb.ConnCase

  alias Cwms.Inventory

  @create_attrs %{description: "some description", model_id: "some model_id", quantity_requested: 42, quantity_units: "some quantity_units", unit_price: 120.5}
