defmodule CwmsWeb.ProductControllerTest do
  use CwmsWeb.ConnCase

  alias Cwms.Inventory

  @create_attrs %{model_id: "some model_id", name: "some name", quantity: 42, unit_price: 120.5, unit_price_cents: 42}
  ...
  describe "update product" do
    ...
    test "redirects when data is valid", %{conn: conn, product: product} do
      ...
      assert html_response(conn, 200) =~ "some updated model_id"
    end
